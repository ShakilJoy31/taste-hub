      ...
      <ul className="w-full mx-auto gap-4">
        {cards.map((card) => (
          <motion.div
            ...
            className="py-4 flex flex-col md:flex-row justify-between items-center hover:bg-neutral-50 dark:hover:bg-neutral-800 rounded-xl cursor-pointer border border-transparent hover:border-neutral-200 dark:hover:border-neutral-700 transition-all"
          >
